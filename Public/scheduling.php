...
if (
    ...
    //verificação para data e hora invalida
    if ($_POST['scheduling_time'] < $dataAtual->format('Y-m-d H:i')) {
        echo "<script>alert('Não é possível agendar uma aula em uma data e hora que já passaram.');  window.location.href = window.location.href ; </script>";
        
        exit();
    }

   else if ($_POST['end_time'] < $dataAtual->format('Y-m-d H:i')) {
        echo "<script>alert('O horário de término não pode ser antes do horário atual.');  window.location.href = window.location.href</script>";
 
        exit();
    }

   else if ($_POST['end_time'] < $_POST['scheduling_time']) {
       echo "<script>alert('O horário de término não pode ser antes do horário de início');  window.location.href = window.location.href</script>";
